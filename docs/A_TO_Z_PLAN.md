...
| v2-c4 | _open_ | Cycle 4: pick between (a) trace-id literal supervision strength at deep span positions, (b) intent→literal-prefix learning, (c) rule-transfer mechanism. Address the residual `evt_mem_dev_000` direct_replay failure + remaining failure_cases that cycle 3.5 did not solve | 🚧 | _next cycle's contract — see `docs/DO_THIS_NEXT.md`_ |
