...
| v2-c4 | _open_ | Cycle 4: pick between (a) role-ordering discrimination at deep segment indices, (b) domain-gating for literal answers, (c) intent→literal-prefix learning. Address the direct_replay regression + remaining failure_cases that cycle 3 did not solve | 🚧 | _next cycle's contract — see `docs/DO_THIS_NEXT.md`_ |
