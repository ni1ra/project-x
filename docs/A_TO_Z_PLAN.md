...
| v2-c7B | 2026-05-14 | Native interactive hidden-rule micro-harness. Loaded v2-c6 parent acts before oracle feedback, learns correction into state, then transfers to held-out parity/threshold/modular marks across two seeds. | ✅ | `run/artifacts/organic-v0/interactive_hidden_rule_cycle7b_summary.json` (aggregate held-out 14/14, total pre-feedback 26/42; parent hash `29958f0880e662dc`); seed artifacts `interactive_hidden_rule_cycle7b_seed7001.json` and `interactive_hidden_rule_cycle7b_seed7002.json`; `docs/artifacts/CYCLE7B_INTERACTIVE_HIDDEN_RULE.md` |
